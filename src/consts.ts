...
export const SITE_DESCRIPTION = 'Come and visit The Fairway Evans Farm';
export const BOOK_TEE_TIME_URL = 'https://yourgolfbooking.com/venues/the-fairway-at-evans-farm/memberships';
export const CONTACT_EMAIL = 'TheFairwayEvansFarm@Gmail.com';
